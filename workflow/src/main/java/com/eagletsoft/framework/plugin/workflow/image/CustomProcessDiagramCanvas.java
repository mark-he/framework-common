...
public class CustomProcessDiagramCanvas {
    ...
    //--MARK
    protected static final int ARC = 7;
    ...
    protected static Color HIGHLIGHT_COLOR = new Color(0, 139, 00, 217);
    ...
    protected static Stroke HIGHLIGHT_FLOW_STROKE = new BasicStroke(1f);
    protected static Stroke ANNOTATION_STROKE = new BasicStroke(1.0f);
    protected static Stroke ASSOCIATION_STROKE = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 1.0f,  new float[] { 2.0f, 2.0f }, 0.0f);
    ...
    protected String activityFontName = "SimHei";
    protected String labelFontName = "SimHei";
    protected String annotationFontName = "SimHei";
    ...
    public void initialize(String imageType) {
        ...
        //Don't like any bold fonts. #MARK
        //Font font = new Font(activityFontNam, Font.BOLD, FONT_SIZE);
    ...
    public void drawHighLight(int x, int y, int width, int height) {
        ...
        RoundRectangle2D rect = new RoundRectangle2D.Double(x + width - 10, y + height - 10, 7, 7, ARC, ARC);
        g.fill(rect);
    ...
    public void drawLabel(String text, GraphicInfo graphicInfo, boolean centered){
        ...
        if (text != null && text.length()>0) {
            ...
            // TODO: use drawMultilineText() --MARK
            drawMultilineText(text, (int)graphicInfo.getX() + TEXT_PADDING * 2, (int)graphicInfo.getY(), wrapWidth, 50, centered);
            /*
