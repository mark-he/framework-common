...
public class CustomProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    protected void drawActivity(CustomProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel,
        ...
        if (drawInstruction != null) {
            ...
            if (highLightedActivities.contains(flowNode.getId())) {
                drawHighLight(flowNode, processDiagramCanvas, bpmnModel.getGraphicInfo(flowNode.getId()));
            }
    ...
    private static void drawHighLight(FlowNode flowNode, CustomProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo) {
